...
import com.labelwall.latte.ui.banner.BannerCreator;
...
public class MultipleRecyclerAdapter extends
    ...
    @Override
    protected void convert(MultipleViewHolder holder, MultipleItemEntity entity) {//数据的转换
        final String text;
